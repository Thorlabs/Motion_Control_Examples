...
namespace KBD_Console_net_managed
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // (i.e. for serial number 28000123, the device prefix is 28)
            ...
            // Create the device - KCube Brushless motor
            KCubeBrushlessMotor device = KCubeBrushlessMotor.CreateKCubeBrushlessMotor(serialNo);
            if (device == null)
            {
                // An error occured
            ...
            KCubeBrushlessMotorSettings currentDeviceSettings = device.MotorDeviceSettings as KCubeBrushlessMotorSettings;
