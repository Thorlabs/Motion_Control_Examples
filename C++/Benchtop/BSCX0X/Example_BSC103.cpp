// Example_BSC103.cpp : Defines the entry point for the console application.
//
...
#if defined TestCode
	#include "..\..\..\Instruments\Thorlabs.Benchtop.StepperMotor\Thorlabs.Benchtop.StepperMotor\Thorlabs.MotionControl.Benchtop.StepperMotor.h"
#else
...
int __cdecl wmain(int argc, wchar_t* argv[])
{
	if(argc < 1)
	{
		printf("Usage = Example_BSC203 [serial_no] [position: optional (0 - 1715200)] [velocity: optional (0 - 3838091)]\r\n");
		char c = _getch();
		return 1;
	}

	int serialNo = 70837825;
	if(argc > 1)
	{
