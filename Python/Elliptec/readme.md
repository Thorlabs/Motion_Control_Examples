...
This example was tested on Windows 11 and Linux Mint 22.2 with a ELL20 stage. It works without using the dll.
For other Elliptec stages, use the appropriate commands as documented in the Communications Protocol.
