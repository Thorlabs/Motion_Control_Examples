...
class LinearTranslationStage(Device,
    ...
    def get_connected_product_info(self) -> TLMC_ConnectedProductInfo:
        return self.feature_group.connectd_product_feature.get_connected_product_info()
    
    def get_connected_products_supported(self, max_length: int) -> tuple[str, int]:
        return self.feature_group.connectd_product_feature.get_connected_products_supported(max_length)
    
    def set_connected_product(self, product_name: str) -> None:
        self.feature_group.connectd_product_feature.set_connected_product(product_name)
    
    def set_connected_product_info(self, product_info: TLMC_ConnectedProductInfo) -> None:
        self.feature_group.connectd_product_feature.set_connected_product_info(product_info)
    ...
    def get_position_counter(self, max_wait_in_milliseconds: int) -> int:
        return self.feature_group.position_counter.get_position_counter(max_wait_in_milliseconds)

    def set_position_counter(self, new_position_counter: int) -> None:
        self.feature_group.position_counter.set_position_counter(new_position_counter)
