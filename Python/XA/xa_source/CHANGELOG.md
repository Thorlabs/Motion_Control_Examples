...
- KSC101 product API support.

### Fixed

- Native API: Checking travel-beyond-limit status of piezo is now successful.
...
- Native API: Resolved unhandled exception on shutdown (caused by background device discovery threads not aborting quickly enough).
