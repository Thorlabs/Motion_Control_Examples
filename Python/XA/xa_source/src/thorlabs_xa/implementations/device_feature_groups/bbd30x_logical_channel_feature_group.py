import thorlabs_xa.interfaces.device_feature_groups.bbd30x_logical_channel_feature_group
...
from thorlabs_xa.implementations.device_features.lcd_move_params_feature import LcdMoveParamsFeature
...
class Bbd30xLogicalChannelFeatureGroup(thorlabs_xa.interfaces.device_feature_groups.bbd30x_logical_channel_feature_group.Bbd30xLogicalChannelFeatureGroup):
    ...
    def __init__(self, device_handle: int, native_functions: NativeFunctions) -> None:
        ...
        self._lcd_move_params_feature = LcdMoveParamsFeature(device_handle, native_functions)
    ...
    @property
    def lcd_move_params_feature(self) -> LcdMoveParams:
        return self._lcd_move_params_feature
