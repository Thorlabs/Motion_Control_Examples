import thorlabs_xa.interfaces.device_feature_groups.bsc20x_feature_group
...
class Bsc20xFeatureGroup(thorlabs_xa.interfaces.device_feature_groups.bsc20x_feature_group.Bsc20xFeatureGroup):
