...
from thorlabs_xa.implementations.device_features.joystick_settings_params_feature import JoystickSettingsParamsFeature
from thorlabs_xa.implementations.device_features.monitor_output_params import MonitorOutputParamsFeature
from thorlabs_xa.implementations.device_features.piezo.nano_trak_circle_diameter_feature import NanoTrakCircleDiameterFeature
...
from thorlabs_xa.implementations.device_features.piezo.nano_trak_circle_to_home_position_feature import NanoTrakCircleToHomePositionFeature
...
from thorlabs_xa.implementations.device_features.piezo.nano_trak_tia_self_calibrate_feature import NanoTrakTiaSelfCalibrateFeature
...
class LnnxFeatureGroup(thorlabs_xa.interfaces.device_feature_groups.lnnx_feature_group.LnnxFeatureGroup):
    ...
    def __init__(self, device_handle: int, native_functions: NativeFunctions) -> None:
        ...
        self._joystick_settings_params_feature = JoystickSettingsParamsFeature(device_handle, native_functions)
        self._monitor_output_params_feature = MonitorOutputParamsFeature(device_handle, native_functions)
        self._nano_trak_circle_diameter_feature = NanoTrakCircleDiameterFeature(device_handle, native_functions)
        ...
        self._nano_trak_circle_to_home_position_feature = NanoTrakCircleToHomePositionFeature(device_handle, native_functions)
        ...
        self._nano_trak_tia_self_calibrate_feature = NanoTrakTiaSelfCalibrateFeature(device_handle, native_functions)
    ...
    @property
    def joystick_settings_params_feature(self) -> JoystickSettingsParams:

        return self._joystick_settings_params_feature
    
    @property
    def monitor_output_params_feature(self) -> MonitorOutputParams:

        return self._monitor_output_params_feature
    
    @property
    def nano_trak_circle_diameter_feature(self) -> NanoTrakCircleDiameter:

        return self._nano_trak_circle_diameter_feature
    ...
    @property
    def nano_trak_circle_to_home_position_feature(self) -> NanoTrakCircleToHomePosition:

        return self._nano_trak_circle_to_home_position_feature
    ...
    @property
    def nano_trak_tia_self_calibrate(self) -> NanoTrakTiaSelfCalibrate:
        return self._nano_trak_tia_self_calibrate_feature
