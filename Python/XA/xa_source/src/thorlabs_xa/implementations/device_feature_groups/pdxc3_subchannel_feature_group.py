import thorlabs_xa.interfaces.device_feature_groups.pdxc3_subchannel_feature_group
...
class Pdxc3SubchannelFeatureGroup(thorlabs_xa.interfaces.device_feature_groups.pdxc3_subchannel_feature_group.Pdxc3SubchannelFeatureGroup):
