import thorlabs_xa.interfaces.device_feature_groups.tbd001_feature_group
...
from thorlabs_xa.implementations.device_features.trigger_params_for_dc_brushless_feature import TriggerParamsForDcBrushlessFeature
...
class Tbd001FeatureGroup(thorlabs_xa.interfaces.device_feature_groups.tbd001_feature_group.Tbd001FeatureGroup):
    ...
    def __init__(self, device_handle: int, native_functions: NativeFunctions) -> None:
        ...
        self._trigger_params_for_dc_brushless_feature = TriggerParamsForDcBrushlessFeature(device_handle, native_functions)
    ...
    def trigger_params_for_dc_brushless_feature(self) -> TriggerParamsForDcBrushless:
        return self._trigger_params_for_dc_brushless_feature
