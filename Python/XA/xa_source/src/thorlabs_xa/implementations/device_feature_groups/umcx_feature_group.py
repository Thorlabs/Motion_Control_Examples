import thorlabs_xa.interfaces.device_feature_groups.umcx_feature_group
...
class UmcxFeatureGroup(thorlabs_xa.interfaces.device_feature_groups.umcx_feature_group.UmcxFeatureGroup):
