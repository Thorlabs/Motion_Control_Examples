import thorlabs_xa.interfaces.device_feature_groups.umcx_stepper_logical_channel_feature_group
...
from thorlabs_xa.implementations.device_features.set_actuator_type_feature import SetActuatorTypeFeature
...
class UmcxStepperLogicalChannelFeatureGroup(thorlabs_xa.interfaces.device_feature_groups.umcx_stepper_logical_channel_feature_group.UmcxStepperLogicalChannelFeatureGroup):
    ...
    def __init__(self, device_handle: int, native_functions: NativeFunctions) -> None:
        ...
        self._set_actuator_type_feature = SetActuatorTypeFeature(device_handle, native_functions)
    ...
    @property
    def set_actuator_type_feature(self) -> SetActuatorType:
        return self._set_actuator_type_feature
