...
class NanoTrakCircleHomePositionFeature(NanoTrakCircleHomePosition):
    ...
    def get_nano_trak_circle_home_position(self, max_wait_in_milliseconds: int) -> TLMC_PZ_NanoTrakCircleHomePositionParams:
        ...
        return self.native_functions.pz_get_nano_trak_circle_home_position(self.device_handle, max_wait_in_milliseconds)

    def set_nano_trak_circle_home_position(self, params: TLMC_PZ_NanoTrakCircleHomePositionParams) -> None:

        self.native_functions.pz_set_nano_trak_circle_home_position(self.device_handle, params)