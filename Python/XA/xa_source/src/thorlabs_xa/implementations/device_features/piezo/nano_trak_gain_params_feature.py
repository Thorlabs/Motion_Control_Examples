...
class NanoTrakGainParamsFeature(NanoTrakGainParams):
    ...
    def get_nano_trak_gain_params(self, max_wait_in_milliseconds: int) -> TLMC_PZ_NanoTrakGainParams:
        ...
        return self.native_functions.pz_get_nano_trak_gain_params(self.device_handle, max_wait_in_milliseconds)

    def set_nano_trak_gain_params(self, params: TLMC_PZ_NanoTrakGainParams) -> None:

        self.native_functions.pz_set_nano_trak_gain_params(self.device_handle, params)