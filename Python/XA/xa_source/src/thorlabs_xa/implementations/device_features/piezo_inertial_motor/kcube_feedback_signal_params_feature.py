...
class KcubeFeedbackSignalParamsFeature(KcubeFeedbackSignalParams):
    ...
    def get_kcube_feedback_signal_params(self, max_wait_in_milliseconds: int) -> TLMC_PZIM_KcubeFeedbackSignalParams:
        ...
        return self.native_functions.pzim_get_kcube_feedback_signal_params(self.device_handle, max_wait_in_milliseconds)

    def set_kcube_feedback_signal_params(self, params: TLMC_PZIM_KcubeFeedbackSignalParams) -> None:

        self.native_functions.pzim_set_kcube_feedback_signal_params(self.device_handle, params)