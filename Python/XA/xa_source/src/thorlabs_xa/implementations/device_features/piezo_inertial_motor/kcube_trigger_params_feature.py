...
class KcubeTriggerParamsFeature(KcubeTriggerParams):
    ...
    def get_kcube_trigger_params(self, max_wait_in_milliseconds: int) -> TLMC_PZIM_KcubeTriggerParams:
        ...
        return self.native_functions.pzim_get_kcube_trigger_params(self.device_handle, max_wait_in_milliseconds)

    def set_kcube_trigger_params(self, params: TLMC_PZIM_KcubeTriggerParams) -> None:

        self.native_functions.pzim_set_kcube_trigger_params(self.device_handle, params)