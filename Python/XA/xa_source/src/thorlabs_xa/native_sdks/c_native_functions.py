import copy
from ctypes import c_bool, c_char_p, c_int16, c_int8, c_uint, c_uint32, byref, c_double, c_uint64, c_ulong, c_int64, c_int32, c_uint16, c_uint8, create_string_buffer
import ctypes
...
from thorlabs_xa.shared.enums import TLMC_AnalogMonitorNumber, TLMC_AuxIoPortMode, TLMC_AuxIoPortNumber, TLMC_BowIndex, TLMC_CalibrationState, TLMC_CurrentLoopScenario, TLMC_DigitalInput, TLMC_DigitalOutput, TLMC_EnableState, TLMC_EndOfMoveMessagesMode, TLMC_IoPortNumber, TLMC_IoPositionTriggerEnableState, TLMC_KcubeMmiLockState, TLMC_AvMode, TLMC_MoveDirection, TLMC_MoveMode, TLMC_OperatingMode, TLMC_PZ_PositionControlMode, TLMC_PZ_SetNanoTrakModeType, TLMC_PZ_StatusBit, TLMC_PZIM_KcubeChannelEnableMode, TLMC_ParameterGroupId, TLMC_PositionLoopScenario, TLMC_RackBayNumber, TLMC_RackBayOccupiedState, TLMC_ResultCode, TLMC_ScaleType, TLMC_SettingStringFormat, TLMC_SolenoidInterlockMode, TLMC_SolenoidOperatingMode, TLMC_SolenoidState, TLMC_SolenoidStatusBit, TLMC_StatusItemId, TLMC_StopMode, TLMC_Unit, TLMC_UniversalStatusBit, TLMC_Wait
...
class CNativeFunctions(NativeFunctions):
    ...
    def get_av_modes(self, handle: int, max_wait_in_milliseconds: int) -> TLMC_AvMode:
        c_av_modes = c_uint16(0)
        CNativeFunctions.wrap_error_code(self.xa_lib.TLMC_GetAvModes(c_ulong(handle), byref(c_av_modes), c_uint64(max_wait_in_milliseconds)))
        return TLMC_AvMode(c_av_modes.value)
    ...
    def get_solenoid_cycle_params(self, handle: int, max_wait_in_milliseconds: int ) -> TLMC_SolenoidCycleParams:
        c_cycle_params = C_TLMC_SolenoidCycleParams()
        CNativeFunctions.wrap_error_code(self.xa_lib.TLMC_GetSolenoidCycleParams(c_ulong(handle), byref(c_cycle_params), c_int64(max_wait_in_milliseconds)))
        return MapNativeToPython.solenoid_cycle_params(c_cycle_params)

    def get_solenoid_interlock_mode(self, handle: int, max_wait_in_milliseconds: int ) -> TLMC_SolenoidInterlockMode:
        c_interlock_mode = c_uint8(0)
        CNativeFunctions.wrap_error_code(self.xa_lib.TLMC_GetSolenoidInterlockMode(c_ulong(handle), byref(c_interlock_mode), c_int64(max_wait_in_milliseconds)))
        return TLMC_SolenoidInterlockMode(c_interlock_mode.value)

    def get_solenoid_operating_mode(self, handle: int, max_wait_in_milliseconds: int ) -> TLMC_SolenoidOperatingMode:
        c_operating_mode = c_uint8(0)
        CNativeFunctions.wrap_error_code(self.xa_lib.TLMC_GetSolenoidOperatingMode(c_ulong(handle), byref(c_operating_mode), c_int64(max_wait_in_milliseconds)))
        return TLMC_SolenoidOperatingMode(c_operating_mode.value)

    def get_solenoid_state(self, handle: int, max_wait_in_milliseconds: int ) -> TLMC_SolenoidState:
        c_state = c_uint8(0)
        CNativeFunctions.wrap_error_code(self.xa_lib.TLMC_GetSolenoidState(c_ulong(handle), byref(c_state), c_int64(max_wait_in_milliseconds)))
        return TLMC_SolenoidState(c_state.value)

    def get_solenoid_status(self, handle: int, max_wait_in_milliseconds: int ) -> TLMC_SolenoidStatus:
        c_solenoid_status = C_TLMC_SolenoidStatus()
        CNativeFunctions.wrap_error_code(self.xa_lib.TLMC_GetSolenoidStatus(c_ulong(handle), c_solenoid_status, c_int64(max_wait_in_milliseconds)))
        return MapNativeToPython.solenoid_status(c_solenoid_status)

    def get_solenoid_status_bits(self, handle: int, max_wait_in_milliseconds: int ) -> TLMC_SolenoidStatusBit:
        c_solenoid_status_bits = c_uint32()
        CNativeFunctions.wrap_error_code(self.xa_lib.TLMC_GetSolenoidStatusBits(c_ulong(handle), byref(c_solenoid_status_bits), c_int64(max_wait_in_milliseconds)))
        return TLMC_SolenoidStatusBit(c_solenoid_status_bits.value)
    ...
    def set_av_modes(self, handle: int, av_modes: TLMC_AvMode) -> None:
        c_av_modes = c_uint16(int(av_modes))
        CNativeFunctions.wrap_error_code(self.xa_lib.TLMC_SetAvModes(c_ulong(handle), c_av_modes))
    ...
    def set_solenoid_cycle_params(self, handle: int, cycle_params: TLMC_SolenoidCycleParams) -> None:
        c_cycle_params = MapPythonToNative.solenoid_cycle_params(cycle_params)
        CNativeFunctions.wrap_error_code(self.xa_lib.TLMC_SetSolenoidCycleParams(c_ulong(handle), byref(c_cycle_params)))

    def set_solenoid_interlock_mode(self, handle: int, interlock_mode: TLMC_SolenoidInterlockMode) -> None:
        c_interlock_mode = c_uint8(int(interlock_mode))
        CNativeFunctions.wrap_error_code(self.xa_lib.TLMC_SetSolenoidInterlockMode(c_ulong(handle), c_interlock_mode))

    def set_solenoid_operating_mode(self, handle: int, operating_mode: TLMC_SolenoidOperatingMode) -> None:
        c_operating_mode = c_uint8(int(operating_mode))
        CNativeFunctions.wrap_error_code(self.xa_lib.TLMC_SetSolenoidOperatingMode(c_ulong(handle), c_operating_mode))

    def set_solenoid_state(self, handle: int, state: TLMC_SolenoidState) -> None:
        c_state = c_uint8(int(state))
        CNativeFunctions.wrap_error_code(self.xa_lib.TLMC_SetSolenoidState(c_ulong(handle), c_state))
