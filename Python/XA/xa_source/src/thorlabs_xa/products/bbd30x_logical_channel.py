...
from thorlabs_xa.interfaces.device_feature_groups.bbd30x_logical_channel_feature_group import Bbd30xLogicalChannelFeatureGroup
...
from thorlabs_xa.shared.params import TLMC_DeviceInfo, TLMC_PositionLoopParams

from thorlabs_xa.shared.enums import TLMC_CurrentLoopScenario, TLMC_EnableState, TLMC_EndOfMoveMessagesMode, TLMC_IoPositionTriggerEnableState, TLMC_MoveMode, TLMC_OperatingMode, TLMC_ParameterGroupId, TLMC_PositionLoopScenario, TLMC_ScaleType, TLMC_SettingStringFormat, TLMC_StatusItemId, TLMC_StopMode, TLMC_Unit, TLMC_UniversalStatusBit
from thorlabs_xa.shared.params import TLMC_ConnectedProductInfo, TLMC_CurrentLoopParams, TLMC_FirmwareVersion, TLMC_GeneralMoveParams, TLMC_HardwareInfo, TLMC_HomeParams, TLMC_IoTriggerParams, TLMC_JogParams, TLMC_JoystickParams, TLMC_LcdMoveParams, TLMC_LimitSwitchParams, TLMC_MotorOutputParams, TLMC_MoveAbsoluteParams, TLMC_MoveRelativeParams, TLMC_ProfileModeParams, TLMC_RichResponse, TLMC_Setting, TLMC_StageAxisParams, TLMC_StatusItem, TLMC_TrackSettleParams, TLMC_UniversalStatus, TLMC_VelocityParams
from thorlabs_xa.shared.device import Device

class Bbd30xLogicalChannel(Device,
        ConnectedProduct,
        CurrentLoopParams,
        EnableState,
    ...
    def __init__(self, device_handle: int, device_info: TLMC_DeviceInfo, feature_group: Bbd30xLogicalChannelFeatureGroup, native_functions: NativeFunctions) -> None:
    ...
    def get_current_loop_params(self, scenario: TLMC_CurrentLoopScenario, max_wait_in_milliseconds: int) -> TLMC_CurrentLoopParams:
        ...
        return self.feature_group.current_loop_params_feature.get_current_loop_params(scenario, max_wait_in_milliseconds)

    def set_current_loop_params(self, scenario: TLMC_CurrentLoopScenario, parameters: TLMC_CurrentLoopParams) -> None:

        self.feature_group.current_loop_params_feature.set_current_loop_params(scenario, parameters)
    ...
    def get_io_position_trigger_enable_state(self, max_wait_in_milliseconds: int) -> TLMC_IoPositionTriggerEnableState:
        ...
        return self.feature_group.io_position_trigger_enable_state_feature.get_io_position_trigger_enable_state(max_wait_in_milliseconds)
    ...
    def set_io_position_trigger_enable_state(self, enable_state: TLMC_IoPositionTriggerEnableState, max_wait_in_milliseconds: int) -> None:
        ...
        self.feature_group.io_position_trigger_enable_state_feature.set_io_position_trigger_enable_state(enable_state, max_wait_in_milliseconds)

    def get_io_trigger_params(self, max_wait_in_milliseconds: int) -> TLMC_IoTriggerParams:

        return self.feature_group.io_trigger_params_feature.get_io_trigger_params(max_wait_in_milliseconds)

    def set_io_trigger_params(self, params: TLMC_IoTriggerParams) -> None:

        self.feature_group.io_trigger_params_feature.set_io_trigger_params(params)
    ...
    def get_joystick_params(self, max_wait_in_milliseconds: int) -> TLMC_JoystickParams:
        ...
        return self.feature_group.joystick_params_feature.get_joystick_params(max_wait_in_milliseconds)

    def set_joystick_params(self, params: TLMC_JoystickParams) -> None:

        self.feature_group.joystick_params_feature.set_joystick_params(params)

    def get_lcd_move_params(self, max_wait_in_milliseconds: int) -> TLMC_LcdMoveParams:

        return self.feature_group.lcd_move_params_feature.get_lcd_move_params(max_wait_in_milliseconds)

    def set_lcd_move_params(self, params: TLMC_LcdMoveParams) -> None:

        self.feature_group.lcd_move_params_feature.set_lcd_move_params(params)
    ...
    def get_motor_output_params(self, max_wait_in_milliseconds: int) -> TLMC_MotorOutputParams:
        ...
        return self.feature_group.motor_output_params_feature.get_motor_output_params(max_wait_in_milliseconds)

    def set_motor_output_params(self, params: TLMC_MotorOutputParams) -> None:

        self.feature_group.motor_output_params_feature.set_motor_output_params(params)
    ...
    def get_position_loop_params(self, scenario: TLMC_PositionLoopScenario, max_wait_in_milliseconds: int) -> TLMC_PositionLoopParams:
        ...
        return self.feature_group.position_loop_params_feature.get_position_loop_params(scenario, max_wait_in_milliseconds)

    def set_position_loop_params(self, scenario: TLMC_PositionLoopScenario, params: TLMC_PositionLoopParams) -> None:

        self.feature_group.position_loop_params_feature.set_position_loop_params(scenario, params)

    def get_profile_mode_params(self, max_wait_in_milliseconds: int) -> TLMC_ProfileModeParams:

        return self.feature_group.profile_mode_params_feature.get_profile_mode_params(max_wait_in_milliseconds)

    def set_profile_mode_params(self, params: TLMC_ProfileModeParams) -> None:

        self.feature_group.profile_mode_params_feature.set_profile_mode_params(params)
    ...
    def get_track_settle_params(self, max_wait_in_milliseconds: int) -> TLMC_TrackSettleParams:
        ...
        return self.feature_group.track_settle_params_feature.get_track_settle_params(max_wait_in_milliseconds)

    def set_track_settle_params(self, params: TLMC_TrackSettleParams) -> None:

        self.feature_group.track_settle_params_feature.set_track_settle_params(params)
