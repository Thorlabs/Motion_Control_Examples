...
from thorlabs_xa.interfaces.device_feature_groups.bpc301_feature_group import Bpc301FeatureGroup
...
from thorlabs_xa.shared.params import TLMC_DeviceInfo, TLMC_PZ_OutputWaveformLookupTableSample

from thorlabs_xa.shared.enums import TLMC_DigitalOutput, TLMC_EnableState, TLMC_OperatingMode, TLMC_PZ_PositionControlMode, TLMC_ScaleType, TLMC_SettingStringFormat, TLMC_PZ_StatusBit, TLMC_StatusItemId, TLMC_Unit
from thorlabs_xa.shared.params import TLMC_FirmwareVersion, TLMC_HardwareInfo, TLMC_PZ_MaxOutputVoltageParams, TLMC_PZ_OutputVoltageControlSourceParams, TLMC_PZ_OutputWaveformParams, TLMC_PZ_PositionLoopParams, TLMC_Setting, TLMC_PZ_SlewRateParams, TLMC_PZ_Status, TLMC_StatusItem
...
class Bpc301(Device,
    ...
    def __init__(self, device_handle: int, device_info: TLMC_DeviceInfo, feature_group: Bpc301FeatureGroup, native_functions: NativeFunctions) -> None:
    ...
    def set_position_loop_params(self, params: TLMC_PZ_PositionLoopParams) -> None:
        ...
        self.feature_group.position_loop_params_feature.set_position_loop_params(params)
    ...
    def get_slew_rate_params(self, max_wait_in_milliseconds: int) -> TLMC_PZ_SlewRateParams:
        ...
        return self.feature_group.slew_rate_params_feature.get_slew_rate_params(max_wait_in_milliseconds)

    def set_slew_rate_params(self, parameters: TLMC_PZ_SlewRateParams) -> None:

        self.feature_group.slew_rate_params_feature.set_slew_rate_params(parameters)
