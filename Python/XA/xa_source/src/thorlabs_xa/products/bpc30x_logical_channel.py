...
from thorlabs_xa.interfaces.device_feature_groups.bpc30x_logical_channel_feature_group import Bpc30xLogicalChannelFeatureGroup
...
from thorlabs_xa.shared.enums import TLMC_EnableState, TLMC_OperatingMode, TLMC_PZ_PositionControlMode, TLMC_ScaleType, TLMC_SettingStringFormat, TLMC_PZ_StatusBit, TLMC_StatusItemId, TLMC_Unit
from thorlabs_xa.shared.params import TLMC_FirmwareVersion, TLMC_HardwareInfo, TLMC_PZ_MaxOutputVoltageParams, TLMC_PZ_OutputVoltageControlSourceParams, TLMC_PZ_OutputWaveformParams, TLMC_PZ_OutputWaveformLookupTableSample, TLMC_PZ_PositionLoopParams, TLMC_Setting, TLMC_PZ_SlewRateParams, TLMC_PZ_Status, TLMC_StatusItem
from thorlabs_xa.shared.device import Device

class Bpc30xLogicalChannel(Device,
        EnableState,
        FirmwareVersionInfo,
        HardwareInfo,
        Identify,
    ...
    def __init__(self, device_handle: int, device_info: TLMC_DeviceInfo, feature_group: Bpc30xLogicalChannelFeatureGroup, native_functions: NativeFunctions) -> None:
