...
from thorlabs_xa.interfaces.device_feature_groups.bsc201_feature_group import Bsc201FeatureGroup
...
class Bsc201(Device,
    ...
    def __init__(self, device_handle: int, device_info: TLMC_DeviceInfo, feature_group: Bsc201FeatureGroup, native_functions: NativeFunctions) -> None:
