...
from thorlabs_xa.interfaces.device_feature_groups.bsc201v4_feature_group import Bsc201v4FeatureGroup
...
class Bsc201v4(Device,
    ...
    def __init__(self, device_handle: int, device_info: TLMC_DeviceInfo, feature_group: Bsc201v4FeatureGroup, native_functions: NativeFunctions) -> None:
