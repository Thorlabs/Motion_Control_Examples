...
from thorlabs_xa.interfaces.device_feature_groups.bsc20x_feature_group import Bsc20xFeatureGroup
...
class Bsc20x(Device,
    ...
    def __init__(self, device_handle: int, device_info: TLMC_DeviceInfo, feature_group: Bsc20xFeatureGroup, native_functions: NativeFunctions) -> None:
