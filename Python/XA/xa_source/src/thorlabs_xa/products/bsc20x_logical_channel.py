...
from thorlabs_xa.interfaces.device_feature_groups.bsc20x_logical_channel_feature_group import Bsc20xLogicalChannelFeatureGroup
...
class Bsc20xLogicalChannel(Device,
        AdcInputs,
        BowIndex,
        ConnectedProduct,
        DigitalOutputStates,
    ...
    def __init__(self, device_handle: int, device_info: TLMC_DeviceInfo, feature_group: Bsc20xLogicalChannelFeatureGroup, native_functions: NativeFunctions) -> None:
