...
from thorlabs_xa.interfaces.device_feature_groups.bsc20xv4_logical_channel_feature_group import Bsc20xv4LogicalChannelFeatureGroup
...
from thorlabs_xa.shared.enums import TLMC_BowIndex, TLMC_DigitalOutput, TLMC_EnableState, TLMC_MoveMode, TLMC_OperatingMode, TLMC_ParameterGroupId, TLMC_ScaleType, TLMC_SettingStringFormat, TLMC_StatusItemId, TLMC_StopMode, TLMC_Unit, TLMC_UniversalStatusBit
from thorlabs_xa.shared.params import TLMC_AdcInputs, TLMC_ConnectedProductInfo, TLMC_FirmwareVersion, TLMC_GeneralMoveParams, TLMC_HardwareInfo, TLMC_HomeParams, TLMC_JogParams, TLMC_JoystickParams, TLMC_LimitSwitchParams, TLMC_MoveAbsoluteParams, TLMC_MoveRelativeParams, TLMC_PowerParams, TLMC_ProfileModeParams, TLMC_RichResponse, TLMC_Setting, TLMC_StatusItem, TLMC_StepperLoopParams, TLMC_StepperStatus, TLMC_TriggerParamsForStepper, TLMC_VelocityParams
from thorlabs_xa.shared.device import Device

class Bsc20xv4LogicalChannel(Device,
        AdcInputs,
        BowIndex,
        ConnectedProduct,
        DigitalOutputStates,
        ...
        StepperStatus,
        Stop,
        TriggerParamsForStepper,
        UnitConverter,
        UniversalStatusBits,
        VelocityParams,
        YesFlashProgramming):

    def __init__(self, device_handle: int, device_info: TLMC_DeviceInfo, feature_group: Bsc20xv4LogicalChannelFeatureGroup, native_functions: NativeFunctions) -> None:
    ...
    def get_adc_inputs(self, max_wait_in_milliseconds: int) -> TLMC_AdcInputs:
        ...
        return self.feature_group.adc_inputs_feature.get_adc_inputs(max_wait_in_milliseconds)
    ...
    def send_no_flash_programming(self) -> None:
        ...
        self.feature_group.no_flash_programming_feature.send_no_flash_programming()
    ...
    def get_trigger_params_for_stepper(self, max_wai_in_milliseconds: int) -> TLMC_TriggerParamsForStepper:
        ...
        return self.feature_group.trigger_params_for_stepper_feature.get_trigger_params_for_stepper(max_wai_in_milliseconds)

    def set_trigger_params_for_stepper(self, params: TLMC_TriggerParamsForStepper) -> None:

        self.feature_group.trigger_params_for_stepper_feature.set_trigger_params_for_stepper(params)
    ...
    def send_yes_flash_programming(self) -> None:

        self.feature_group.yes_flash_programming_feature.send_yes_flash_programming()