...
from thorlabs_xa.interfaces.device_feature_groups.kst101_feature_group import Kst101FeatureGroup
...
class Kst101(Device,
    ...
    def __init__(self, device_handle: int, device_info: TLMC_DeviceInfo, feature_group: Kst101FeatureGroup, native_functions: NativeFunctions) -> None:
