...
from thorlabs_xa.shared.params import TLMC_DeviceInfo, TLMC_FirmwareVersion, TLMC_HardwareInfo, TLMC_JoystickSettingsParams, TLMC_MonitorOutputParams, TLMC_PZ_NanoTrakCircleDiameterLookupTableData, TLMC_PZ_NanoTrakCircleHomePositionParams, TLMC_PZ_NanoTrakCircleParams, TLMC_PZ_NanoTrakEEPROMParams, TLMC_PZ_NanoTrakGainParams, TLMC_PZ_NanoTrakMode, TLMC_PZ_NanoTrakPhaseCompensationParams, TLMC_PZ_NanoTrakRangeParams, TLMC_PZ_NanoTrakStatus, TLMC_RichResponse, TLMC_Setting
...
class Lnnx(Device,
    ...
    def get_joystick_settings_params(self, max_wait_in_milliseconds: int) -> TLMC_JoystickSettingsParams:
        return self.feature_group.joystick_settings_params_feature.get_joystick_settings_params(max_wait_in_milliseconds)
    
    def set_joystick_settings_params(self, params: TLMC_JoystickSettingsParams) -> None:
        self.feature_group.joystick_settings_params_feature.set_joystick_settings_params(params)
    
    def get_monitor_output_params(self, max_wait_in_milliseconds: int) -> TLMC_MonitorOutputParams:
        return self.feature_group.monitor_output_params_feature.get_monitor_output_params(max_wait_in_milliseconds)
    
    def set_monitor_output_params(self, params: TLMC_MonitorOutputParams) -> None:
        self.feature_group.monitor_output_params_feature.set_monitor_output_params(params)

    def set_nano_trak_circle_diameter(self, circle_diameter: int) -> None:
        self.feature_group.nano_trak_circle_diameter_feature.set_nano_trak_circle_diameter(circle_diameter)
    ...
    def nano_trak_circle_to_home_position(self) -> None:
        self.feature_group.nano_trak_circle_to_home_position_feature.nano_trak_circle_to_home_position()

    def nano_trak_tia_self_calibrate(self) -> None:
        return self.feature_group.nano_trak_tia_self_calibrate.nano_trak_tia_self_calibrate()
