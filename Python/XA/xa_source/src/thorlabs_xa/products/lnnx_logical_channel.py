...
from thorlabs_xa.shared.params import TLMC_ConnectedProductInfo, TLMC_DeviceInfo, TLMC_FirmwareVersion, TLMC_HardwareInfo, TLMC_PZ_MaxOutputVoltageParams, TLMC_PZ_OutputVoltageControlSourceParams, TLMC_PZ_StageInfoParams, TLMC_PZ_Status, TLMC_Setting, TLMC_StatusItem
...
class LnnxLogicalChannel(Device,
    ...
    def set_connected_product_info(self, product_info: TLMC_ConnectedProductInfo) -> None:
        return self.feature_group.connected_product_feature.set_connected_product_info(product_info)
    
    def set_connected_product(self, product_name: str) -> None:
        return self.feature_group.connected_product_feature.set_connected_product(product_name)
    ...
    def disconnect(self) -> None:
        return self.feature_group.disconnect_product_feature.disconnect()
    ...
    def get_stage_info_params(self, max_wait_in_milliseconds: int) -> TLMC_PZ_StageInfoParams:
        return self.feature_group.stage_info_params_feature.get_stage_info_params(max_wait_in_milliseconds)
    ...
    def set_status_mode(self, operating_mode: TLMC_OperatingMode) -> None:
        self.feature_group.set_status_mode_feature.set_status_mode(operating_mode)
