...
from thorlabs_xa.interfaces.device_feature_groups.pdxc2_feature_group import Pdxc2FeatureGroup
...
from thorlabs_xa.shared.params import TLMC_ConnectedProductInfo, TLMC_FirmwareVersion, TLMC_HardwareInfo, TLMC_RichResponse, TLMC_Setting, TLMC_StageAxisParams, TLMC_StatusItem
...
class Pdxc2(Device,
    ...
    def __init__(self, device_handle: int, device_info: TLMC_DeviceInfo, feature_group: Pdxc2FeatureGroup, native_functions: NativeFunctions) -> None:
