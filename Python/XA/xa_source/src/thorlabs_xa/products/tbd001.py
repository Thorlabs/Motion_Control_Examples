...
from thorlabs_xa.interfaces.device_feature_groups.tbd001_feature_group import Tbd001FeatureGroup
...
from thorlabs_xa.shared.enums import TLMC_CurrentLoopScenario, TLMC_DigitalOutput, TLMC_EnableState, TLMC_MoveMode, TLMC_OperatingMode, TLMC_ParameterGroupId, TLMC_PositionLoopScenario, TLMC_ScaleType, TLMC_SettingStringFormat, TLMC_StatusItemId, TLMC_StopMode, TLMC_Unit, TLMC_UniversalStatusBit
from thorlabs_xa.shared.params import TLMC_ConnectedProductInfo, TLMC_CurrentLoopParams, TLMC_FirmwareVersion, TLMC_GeneralMoveParams, TLMC_HardwareInfo, TLMC_HomeParams, TLMC_JogParams, TLMC_JoystickParams, TLMC_LimitSwitchParams, TLMC_MotorOutputParams, TLMC_MoveAbsoluteParams, TLMC_MoveRelativeParams, TLMC_PositionLoopParams, TLMC_ProfileModeParams, TLMC_RichResponse, TLMC_Setting, TLMC_StageAxisParams, TLMC_StatusItem, TLMC_TrackSettleParams, TLMC_TriggerParamsForDcBrushless, TLMC_UniversalStatus, TLMC_VelocityParams
...
class Tbd001(Device,
        ...
        Stop,
        TrackSettleParams,
        TriggerParamsForDcBrushless,
        UnitConverter,
        UniversalStatus,
        UniversalStatusBits,
        VelocityParams):

    def __init__(self, device_handle: int, device_info: TLMC_DeviceInfo, feature_group: Tbd001FeatureGroup, native_functions: NativeFunctions) -> None:
    ...
    def get_trigger_params_for_dc_brushless(self, max_wait_in_milliseconds: int) -> TLMC_TriggerParamsForDcBrushless:
        ...
        return self.feature_group.trigger_params_for_dc_brushless_feature.get_trigger_params_for_dc_brushless(max_wait_in_milliseconds)

    def set_trigger_params_for_dc_brushless(self, params: TLMC_TriggerParamsForDcBrushless) -> None:

        self.feature_group.trigger_params_for_dc_brushless_feature.set_trigger_params_for_dc_brushless(params)
