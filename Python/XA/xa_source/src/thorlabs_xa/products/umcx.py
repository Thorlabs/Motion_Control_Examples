...
from thorlabs_xa.interfaces.device_feature_groups.umcx_feature_group import UmcxFeatureGroup
...
from thorlabs_xa.shared.enums import TLMC_AuxIoPortMode, TLMC_AuxIoPortNumber, TLMC_IoPortNumber, TLMC_RackBayNumber, TLMC_RackBayOccupiedState, TLMC_SettingStringFormat
from thorlabs_xa.shared.params import TLMC_FirmwareVersion, TLMC_HardwareInfo, TLMC_IoConfigurationParams, TLMC_MoveSyncArray, TLMC_MoveSyncParams, TLMC_MoveSyncStartParams, TLMC_Setting
...
class Umcx(Device,
    ...
    def __init__(self, device_handle: int, device_info: TLMC_DeviceInfo, feature_group: UmcxFeatureGroup, native_functions: NativeFunctions) -> None:
