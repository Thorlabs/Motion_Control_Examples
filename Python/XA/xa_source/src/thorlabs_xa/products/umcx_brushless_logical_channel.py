...
from thorlabs_xa.interfaces.device_feature_groups.umcx_brushless_logical_channel_feature_group import UmcxBrushlessLogicalChannelFeatureGroup
...
from thorlabs_xa.shared.params import TLMC_ConnectedProductInfo, TLMC_CurrentLoopParams, TLMC_FirmwareVersion, TLMC_GeneralMoveParams, TLMC_HardwareInfo, TLMC_HomeParams, TLMC_IoTriggerParams, TLMC_JogParams, TLMC_JoystickParams, TLMC_LimitSwitchParams, TLMC_MotorOutputParams, TLMC_MoveAbsoluteParams, TLMC_MoveRelativeParams, TLMC_PositionLoopParams, TLMC_ProfileModeParams, TLMC_RichResponse, TLMC_Setting, TLMC_StageAxisParams, TLMC_UmcStatus, TLMC_StatusItem, TLMC_TrackSettleParams, TLMC_VelocityParams
from thorlabs_xa.shared.device import Device

class UmcxBrushlessLogicalChannel(Device,
        ConnectedProduct,
        CurrentLoopParams,
        EnableState,
    ...
    def __init__(self, device_handle: int, device_info: TLMC_DeviceInfo, feature_group: UmcxBrushlessLogicalChannelFeatureGroup, native_functions: NativeFunctions) -> None:
    ...
    def get_umc_status(self, max_wait_in_milliseconds: int) -> TLMC_UmcStatus:
        ...
        return self.feature_group.umc_status_feature.get_umc_status(max_wait_in_milliseconds)
