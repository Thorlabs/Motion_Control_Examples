...
from thorlabs_xa.interfaces.device_feature_groups.umcx_stepper_logical_channel_feature_group import UmcxStepperLogicalChannelFeatureGroup
...
from thorlabs_xa.shared.enums import TLMC_BowIndex, TLMC_CurrentLoopScenario, TLMC_DigitalOutput, TLMC_EnableState, TLMC_IoPositionTriggerEnableState, TLMC_MoveMode, TLMC_OperatingMode, TLMC_ParameterGroupId, TLMC_ScaleType, TLMC_SettingStringFormat, TLMC_StatusItemId, TLMC_StopMode, TLMC_Unit, TLMC_UniversalStatusBit
from thorlabs_xa.shared.params import TLMC_ConnectedProductInfo, TLMC_CurrentLoopParams, TLMC_FirmwareVersion, TLMC_GeneralMoveParams, TLMC_HardwareInfo, TLMC_HomeParams, TLMC_IoTriggerParams, TLMC_JogParams, TLMC_JoystickParams, TLMC_LimitSwitchParams, TLMC_MoveAbsoluteParams, TLMC_MoveRelativeParams, TLMC_PowerParams, TLMC_ProfileModeParams, TLMC_RichResponse, TLMC_Setting, TLMC_StageAxisParams, TLMC_UmcStatus, TLMC_StatusItem, TLMC_StepperLoopParams, TLMC_VelocityParams
from thorlabs_xa.shared.device import Device

class UmcxStepperLogicalChannel(Device,
        BowIndex,
        ConnectedProduct,
        CurrentLoopParams,
        DigitalOutputStates,
    ...
    def __init__(self, device_handle: int, device_info: TLMC_DeviceInfo, feature_group: UmcxStepperLogicalChannelFeatureGroup, native_functions: NativeFunctions) -> None:
    ...
    def set_actuator_type(self, actuator_type: int) -> None:
        ...
        self.feature_group.set_actuator_type_feature.set_actuator_type(actuator_type)
    ...
    def get_stepper_loop_params(self, max_wait_in_milliseconds: int) -> TLMC_StepperLoopParams:
        ...
        return self.feature_group.stepper_loop_params_feature.get_stepper_loop_params(max_wait_in_milliseconds)

    def set_stepper_loop_params(self, params: TLMC_StepperLoopParams) -> None:

        self.feature_group.stepper_loop_params_feature.set_stepper_loop_params(params)
