...
class C_TLMC_JoystickSettingsParams(Structure):
    _pack_ = 1
    _fields_ = [
        ("joystickSerialInterface", c_uint8),
        ("joystickModel", c_uint8),
        ("directionSense", c_uint16 * 3),
        ("axisMapping", c_uint8 * 3),
        ("reserved", c_int32 * 8)
]
...
class C_TLMC_MonitorOutputParams(Structure):
    _pack_ = 1
    _fields_ = [
        ("monitorOutput", c_uint16),
        ("dac", c_uint16)]
...
class C_TLMC_PZ_LnnxControlLoopParams(Structure):
    _pack_ = 1
    _fields_ = [
        ("overrideMode", c_uint8),
        ("proportional", c_uint8),
        ("integral", c_uint8),
        ("derivative", c_uint8),
        ("feedForward", c_uint8)
]

class C_TLMC_PZ_LnnxNotchFilterParams(Structure):
    _pack_ = 1
    _fields_ = [
        ("overrideMode", c_uint8),
        ("filter1CenterFrequency", c_uint16),
        ("filter1QualityFactor", c_uint8),
        ("filter2CenterFrequency", c_uint16),
        ("filter2QualityFactor", c_uint8)
]
...
class C_TLMC_PZ_NanoTrakStatus(Structure):
    ...
    _fields_ = [("circlePositionA", c_uint16),
                ...
                ("relativeReading", c_uint16),
                ("range", c_uint16),
                ("underOverRead", c_uint16),
                ("statusBits", c_uint32),
...
class C_TLMC_PZ_StageInfoParams(Structure):
    _pack_ = 1
    _fields_ = [
        ("productId", c_uint16),
        ("stageName", c_char * 16),
        ...
        ("maxVoltage", c_int16),
        ("minNegativeVoltage", c_int16),
        ("sensorType", c_uint8),
        ("axisType", c_uint16),
        ("nominalTravel", c_uint16),
        ("homePosition", c_int16),
        ("reserved", c_uint8 * 32)
]
...
class C_TLMC_SolenoidCycleParams(Structure):
    _pack_ = 1
    _fields_ = [
        ("onTime", c_uint32),
        ("offTime", c_uint32),
...
class C_TLMC_SolenoidStatus(Structure):
    _pack_ = 1
    _fields_ = [
        ("position", c_int32),
        ("encoderCounts", c_int32),
        ("statusBits", c_uint32)
]
...
class C_TLMC_StepperLoopParams(Structure):
    ...
    _fields_ = [("loopMode", c_uint16),
                ...
                ("microstepsPerEncoderCount", c_int32),
                ("reserved", c_uint8 * 8)
                ]
