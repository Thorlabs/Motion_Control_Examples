...
from thorlabs_xa.implementations.device_feature_groups.ksc101_feature_group import Ksc101FeatureGroup
...
from thorlabs_xa.products.ksc101 import Ksc101
...
class DeviceFactory:
    ...
    def create(self, device_handle: int, device_info: TLMC_DeviceInfo) -> Device:
        ...
        match device_info.device_type:
            ...
            case TLMC_DeviceType.TLMC_DeviceType_Ksc101:
                feature_group = Ksc101FeatureGroup(device_handle, self.native_functions)
                return Ksc101(device_handle, device_info, feature_group, self.native_functions)
