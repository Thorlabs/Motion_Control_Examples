...
class TLMC_AvMode(IntFlag):
    TLMC_AvMode_Identify = 0x0001
    TLMC_AvMode_LimitSwitch = 0x0002
    TLMC_AvMode_Moving = 0x0008
...
class TLMC_SolenoidInterlockMode(IntEnum):
    TLMC_SolenoidInterlockMode_Enabled = 0x01
    TLMC_SolenoidInterlockMode_Disabled = 0x02

class TLMC_SolenoidState(IntEnum):
    TLMC_SolenoidState_On = 0x01
    TLMC_SolenoidState_Off = 0x02

class TLMC_SolenoidStatusBit(IntFlag):
    TLMC_SolenoidStatusBit_TLMC_SolenoidState_SolenoidState = 0x00000001
    TLMC_SolenoidStatusBit_TLMC_SolenoidState_CounterclockwiseHardLimit = 0x00000002
    TLMC_SolenoidStatusBit_TLMC_SolenoidState_ClockwiseSoftLimit = 0x00000004
    TLMC_SolenoidStatusBit_TLMC_SolenoidState_CounterclockwiseSoftLimit = 0x00000008
    TLMC_SolenoidStatusBit_TLMC_SolenoidState_MovingClockwise = 0x00000010
    TLMC_SolenoidStatusBit_TLMC_SolenoidState_MovingCounterclockwise = 0x00000020
    TLMC_SolenoidStatusBit_TLMC_SolenoidState_JoggingClockwise = 0x00000040
    TLMC_SolenoidStatusBit_TLMC_SolenoidState_JoggingCounterclockwise = 0x00000080
    TLMC_SolenoidStatusBit_TLMC_SolenoidState_Connected = 0x00000100
    TLMC_SolenoidStatusBit_TLMC_SolenoidState_Homing = 0x00000200
    TLMC_SolenoidStatusBit_TLMC_SolenoidState_Homed = 0x00000400
    TLMC_SolenoidStatusBit_TLMC_SolenoidState_Interlock = 0x00001000
    TLMC_SolenoidStatusBit_TLMC_SolenoidState_KeyswitchState = 0x00002000
    TLMC_SolenoidStatusBit_TLMC_SolenoidState_DigitalInput1 = 0x00100000
    TLMC_SolenoidStatusBit_TLMC_SolenoidState_DigitalInput2 = 0x00200000
    TLMC_SolenoidStatusBit_TLMC_SolenoidState_DigitalInput3 = 0x00400000
    TLMC_SolenoidStatusBit_TLMC_SolenoidState_DigitalInput4 = 0x00800000
    TLMC_SolenoidStatusBit_TLMC_SolenoidState_DigitalInput5 = 0x01000000
    TLMC_SolenoidStatusBit_TLMC_SolenoidState_DigitalInput6 = 0x02000000
    TLMC_SolenoidStatusBit_TLMC_SolenoidState_PowerOk = 0x10000000
    TLMC_SolenoidStatusBit_TLMC_SolenoidState_Active = 0x20000000
    TLMC_SolenoidStatusBit_TLMC_SolenoidState_Error = 0x40000000
    TLMC_SolenoidStatusBit_TLMC_SolenoidState_Enabled = 0x80000000

class TLMC_SolenoidOperatingMode(IntEnum):
    TLMC_SOL_OperatingMode_SolenoidManual = 0x01
    TLMC_SOL_OperatingMode_SolenoideSingle = 0x02
    TLMC_SOL_OperatingMode_SolenoidAuto = 0x03
    TLMC_SOL_OperatingMode_SolenoidTrigger = 0x04
...
class TLMC_StatusItemId(IntEnum):
    ...
    TLMC_StatusItemId_SolenoidState = 68
    TLMC_StatusItemId_SolenoidOn = 69
    TLMC_StatusItemId_KeySwitchState = 70
