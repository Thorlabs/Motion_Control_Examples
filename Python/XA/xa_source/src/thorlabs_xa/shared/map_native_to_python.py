...
class MapNativeToPython:
    ...
    def move_sync_array(c_params: C_TLMC_MoveSyncArray) -> TLMC_MoveSyncArray:
        ...
        params.time_positions = c_params.timePositions
