...
class TLMC_SolenoidCycleParams():
...
class TLMC_SolenoidStatus():

    def __init__(self):

        self._position = 0
        self._encoder_counts = 0
        self._status_bits = TLMC_SolenoidStatusBit.TLMC_SolenoidStatusBit_TLMC_SolenoidState_SolenoidState
    ...
    def encoder_counts(self, val: int):
        self._encoder_counts = val

    @property
    def status_bits(self) -> TLMC_SolenoidStatusBit:
        return self._status_bits

    @status_bits.setter
    def status_bits(self, val: TLMC_SolenoidStatusBit):
        self._status_bits = val
